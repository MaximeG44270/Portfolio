...
const Realisation2: React.FC = () => {
  return (
    <div>
        <img src="/Image-portfolio/bloc-4/Projet-2.png" alt="Image 1" className="mt-8 px-4 md:px-8 lg:px-10 lg:mt-24" />
        ...
        <div className="flex self-start ml-4 mt-4 items-center">
            ...
            <a 
              href="https://interactive-rote.netlify.app/" 
              target="_blank" 
